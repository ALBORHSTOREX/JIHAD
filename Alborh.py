...
os.system('https://www.facebook.com/sabri.abidin.3')

os.system('xdg-open https://www.facebook.com/sabri.abidin.3')
...
╚█████╔╝██║██║  ██║██║  ██║██████╔╝
 ╚════╝ ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═════╝ 
  ...
  FACEBOOK :   JIHAD-ZAMZAM

  GITHUB    :   LB JIHAD

  LIFE STATUS  :  JIHAD-1982🖕🏻

  FB GROUP  : OSAMA HACKER 0005
